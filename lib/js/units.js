function init_units() {
    ...
    unit['Erg'] = [ 10000000, 0 ];
    unit['Foot-pound'] = [0.73756214927727,0];
    unit['gigajoule (GJ)'] = [1e-9,0];
    unit['Joule'] = [ 1, 0 ];
    unit['Kilocalorie(kcal)'] = [ 0.00023884589662749595, 0 ];
    unit['Kilojoule (kJ)'] = [0.001,0];
    unit['Kilowatt hour (kWh)'] = [2.7777777777778e-7,0];
    unit['Megajoule (MJ)'] = [0.000001,0];
    unit['Rydberg'] = [ 4.5873663929538054e17, 0 ];
    unit['Therm'] = [ 9.47813394498891e-9, 0 ];
    unit['Ton of TNT (tn)'] = [2.3900573613767e-10,0];
    unit['Watt hour (Wh)'] = [0.00027777777777778,0];
    unit_hash['energy'] = unit;
    unit = {};
    unit['Attonewton'] = [10000000000000000000,0];
    unit['Centinewton'] = [100,0];
    unit['Decigram-force'] = [1019.716213,0];
    unit['Decinewton'] = [10,0];
    unit['Dekagram-force'] = [10.19716213,0];
    unit['Dekanewton'] = [0.1,0];
    unit['Exanewton'] = [1e-17,0];
    unit['Femtonewton'] = [10000000000000000,0];
    unit['Giganewton (GN)'] = [1e-8,0];
    unit['Gram-force'] = [101.9716213,0];
    unit['Hectonewton'] = [0.01,0];
    unit['Joule / meter (J/m)'] = [1,0];
    unit['Kilonewton (kN)'] = [0.001,0];
    unit['Kilopond (kp)'] = [0.1019716,0];
    unit['Kip (kip)'] = [0.0002248,0];
    unit['Meganewton'] = [0.00001,0];
    unit['Megapond'] = [0.0001019716213,0];
    unit['Micronewton (ÂµN)'] = [1000000,0];
    unit['Millinewton (mN)'] = [1000,0];
    unit['Nanonewton (nN)'] = [1000000000,0];
    unit['Ounce-force (ozf)'] = [3.5969431019,0];
    unit['Petanewton'] = [1e-14,0];
    unit['Piconewton'] = [1000000000000,0];
    unit['Pond'] = [101.9716213,0];
    unit['Sthene (sn)'] = [0.001,0];
    unit['Teranewton'] = [1e-11,0];
    unit['Yoctonewton'] = [1e+25,0];
    unit['Yottanewton'] = [1e-23,0];
    unit['Zeptonewton'] = [1e+22,0];
    unit['Zettanewton'] = [1e-20,0];
    unit['Dyne'] = [ 100000, 0 ];
    ...
    unit = {};
    unit['Julian year'] = [0.0027378507871321,0];
    unit['Gregorian year'] = [0.0027379070069885,0];
    unit['Millisecond'] = [86400000,0];
    unit['Microsecond'] = [86400000000,0];
    unit['Nanosecond'] = [86400000000000,0];
